...
class StoreTestCaseTemplateRequest extends FormRequest
{
    /**
    ...
    public function messages(): array
    {
        return [
            ...
            'fields.*.name.required' => 'Chaque champ doit avoir un nom',
            'fields.*.label.required' => 'Chaque champ doit avoir un libellé',
            'fields.*.type.required' => 'Chaque champ doit avoir un type',
