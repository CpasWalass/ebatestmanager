        ...
        <div class="flex items-center gap-2" x-data="{ openActions:false }">
            ...
            <div class="relative">
                ...
                <div x-show="openActions" x-cloak @click.outside="openActions=false"
                    ...
                    @else
                    <div class="border-t border-gray-100 dark:border-gray-700 my-1"></div>
                    <button wire:click="reopenProject" wire:confirm="Êtes-vous sûr de vouloir réactiver ce projet ?" class="w-full text-left flex items-center gap-3 px-4 py-2.5 text-sm text-amber-700 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/20 transition">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/></svg>
                        Réactiver le projet
                    </button>
                    @endif
