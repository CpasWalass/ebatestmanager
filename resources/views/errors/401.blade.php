...
<title>EbaTestManager — Non autorisé</title>
...
<body class="text-gray-900 dark:text-gray-100 flex flex-col">
  ...
  <main class="flex-1 flex items-center justify-center px-4 py-16 relative z-10">
    <div class="text-center max-w-lg">
      ...
      <div class="error-code mb-4">401</div>
      <h1 class="text-2xl font-bold mb-3 text-gray-900 dark:text-white">Non autorisé</h1>
      <p class="text-gray-500 dark:text-gray-400 text-sm mb-10 leading-relaxed">
        Vous devez être connecté pour accéder à cette ressource.<br>
        Veuillez vous authentifier pour continuer.
      </p>
      <div class="flex items-center justify-center gap-3 flex-wrap">
        <a href="{{ route('login') }}" class="btn-primary inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-white text-sm font-semibold">
