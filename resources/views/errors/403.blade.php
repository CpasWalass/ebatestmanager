...
<title>EbaTestManager — Accès refusé</title>
...
<body class="text-gray-900 dark:text-gray-100 flex flex-col">
  <div aria-hidden="true" style="position:fixed;inset:0;pointer-events:none;overflow:hidden;z-index:0;">
    ...
    <div class="particle" style="left:40%;width:5px;height:5px;animation-duration:22s;animation-delay:4s;"></div>
    <div class="particle" style="left:70%;width:9px;height:9px;animation-duration:16s;animation-delay:7s;"></div>
  </div>
  ...
  <main class="flex-1 flex items-center justify-center px-4 py-16 relative z-10">
    <div class="text-center max-w-lg">
      ...
      <h1 class="text-2xl font-bold mb-3 text-gray-900 dark:text-white">Accès refusé</h1>
      <p class="text-gray-500 dark:text-gray-400 text-sm mb-10 leading-relaxed">
        ...
        Contactez votre chef de projet si vous pensez que c'est une erreur.
      </p>
      <div class="flex items-center justify-center gap-3 flex-wrap">
        <a href="{{ url()->previous() !== url()->current() ? url()->previous() : '/' }}" class="btn-secondary inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800">
