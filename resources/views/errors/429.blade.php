...
<title>EbaTestManager — Trop de requêtes</title>
...
<style>
  ...
  .countdown-bar {
    ...
    background: linear-gradient(90deg, #8b0000, #c23b3b);
...
<body class="text-gray-900 dark:text-gray-100 flex flex-col">
  ...
  <main class="flex-1 flex items-center justify-center px-4 py-16 relative z-10">
    <div class="text-center max-w-lg">
      ...
      <div class="error-code mb-4">429</div>
      <h1 class="text-2xl font-bold mb-3 text-gray-900 dark:text-white">Trop de requêtes</h1>
      ...
      <div class="w-full max-w-xs mx-auto mb-8">
        ...
        <p class="text-xs text-gray-400 mt-2">Réessayez dans quelques instants…</p>
      </div>
